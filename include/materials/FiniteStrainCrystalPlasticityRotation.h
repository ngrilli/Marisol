...
#ifndef FINITESTRAINCRYSTALPLASTICITYROTATION_H
#define FINITESTRAINCRYSTALPLASTICITYROTATION_H

#include "ComputeStressBase.h"

class FiniteStrainCrystalPlasticityRotation;

template <>
InputParameters validParams<FiniteStrainCrystalPlasticityRotation>();
 ...
 */
class FiniteStrainCrystalPlasticityRotation : public ComputeStressBase
{
public:
  FiniteStrainCrystalPlasticityRotation(const InputParameters & parameters);
...
protected:
  ...
  MaterialProperty<std::vector<Real>> & _gssincr;
  ...
  MaterialProperty<RankTwoTensor> & _re;

/*
  const VariableGradient & _grad_fp1;
  const VariableGradient & _grad_fp2;
  const VariableGradient & _grad_fp3;

  MaterialProperty<Real> & _fp1;
  MaterialProperty<Real> & _fp2;
  MaterialProperty<Real> & _fp3;
    
  MaterialProperty<RankTwoTensor> & _curl_fp;
*/
  ...
  MaterialProperty<std::vector<Real>> & _fp1;
  MaterialProperty<std::vector<Real>> & _fp2;
  MaterialProperty<std::vector<Real>> & _fp3;
    
  /*
  const VectorVariableCurl & _curl_fp1;
  const VectorVariableCurl & _curl_fp2;
  const VectorVariableCurl & _curl_fp3;
  MaterialProperty<RankTwoTensor> & _curl_fp;
  const MaterialProperty<RankTwoTensor> & _curl_fp_old;
   */
    
  // const MaterialProperty<std::vector<Real>> & _fp1_old;
  // const MaterialProperty<std::vector<Real>> & _fp2_old;
  // const MaterialProperty<std::vector<Real>> & _fp3_old;
...
#endif // FINITESTRAINCRYSTALPLASTICITYROTATION_H

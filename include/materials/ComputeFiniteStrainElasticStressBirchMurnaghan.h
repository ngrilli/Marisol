...
class ComputeFiniteStrainElasticStressBirchMurnaghan;

template <>
InputParameters validParams<ComputeFiniteStrainElasticStressBirchMurnaghan>();

/**
 * ComputeFiniteStrainElasticStressBirchMurnaghan computes the stress following elasticity
 ...
 */
class ComputeFiniteStrainElasticStressBirchMurnaghan : public ComputeStressBase, public GuaranteeConsumer
{
public:

...
/****************************************************************/
#ifndef LINEARISOELASTICPFDAMAGESYM_H
#define LINEARISOELASTICPFDAMAGESYM_H
 ...
 */
class LinearIsoElasticPFDamageSym : public ComputeStressBase
{
public:
  LinearIsoElasticPFDamageSym(const InputParameters & parameters);
...
#endif // LINEARISOELASTICPFDAMAGESYM_H

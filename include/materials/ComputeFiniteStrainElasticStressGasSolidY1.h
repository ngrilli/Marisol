...
#ifndef COMPUTEFINITESTRAINELASTICSTRESSGASSOLIDY1_H
#define COMPUTEFINITESTRAINELASTICSTRESSGASSOLIDY1_H

#include "ComputeStressBase.h"
#include "GuaranteeConsumer.h"

class ComputeFiniteStrainElasticStressGasSolidY1;

template <>
InputParameters validParams<ComputeFiniteStrainElasticStressGasSolidY1>();

/**
 * ComputeFiniteStrainElasticStressGasSolidY1 computes the stress following elasticity
 ...
 */
class ComputeFiniteStrainElasticStressGasSolidY1 : public ComputeStressBase, public GuaranteeConsumer
{
public:
  ComputeFiniteStrainElasticStressGasSolidY1(const InputParameters & parameters);
...
#endif // COMPUTEFINITESTRAINELASTICSTRESSGASSOLIDY1_H

...
/****************************************************************/
#ifndef FINITESTRAINCRYSTALPLASTICITYDAMAGEAMOR_H
#define FINITESTRAINCRYSTALPLASTICITYDAMAGEAMOR_H
 ...
 */
class FiniteStrainCrystalPlasticityDamageAmor;

template<>
InputParameters validParams<FiniteStrainCrystalPlasticityDamageAmor>();

class FiniteStrainCrystalPlasticityDamageAmor : public FiniteStrainCrystalPlasticity
{
public:
  FiniteStrainCrystalPlasticityDamageAmor(const InputParameters & parameters);
...
#endif //FINITESTRAINCRYSTALPLASTICITYDAMAGEAMOR_H

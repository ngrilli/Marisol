...
/****************************************************************/
#ifndef LINEARISOELASTICPFPOSVOL_H
#define LINEARISOELASTICPFPOSVOL_H
 ...
 */
class LinearIsoElasticPFPosVol : public ComputeStressBase
{
public:
  LinearIsoElasticPFPosVol(const InputParameters & parameters);
...
#endif //LinearIsoElasticPFPOSVOL_H

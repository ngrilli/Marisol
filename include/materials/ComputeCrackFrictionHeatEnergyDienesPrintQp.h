...
/****************************************************************/
#ifndef COMPUTECRACKFRICTIONHEATENERGYDIENESPRINTQP_H
#define COMPUTECRACKFRICTIONHEATENERGYDIENESPRINTQP_H
 ...
 * print heat_rate at quadrature point
 */
class ComputeCrackFrictionHeatEnergyDienesPrintQp : public DerivativeMaterialInterface<Material>
{
public:
  ComputeCrackFrictionHeatEnergyDienesPrintQp(const InputParameters & parameters);
...
#endif // COMPUTECRACKFRICTIONHEATENERGYDIENESPRINTQP_H

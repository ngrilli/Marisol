...
#include "ComputeCrackFrictionHeatEnergyDienesPrintQp.h"

template <>
InputParameters
validParams<ComputeCrackFrictionHeatEnergyDienesPrintQp>()
{
  ...
  params.addClassDescription("Heat energy density generated by crack friction, according to Dienes 2006"
                             "Print heat rate at quadrature points");
...
ComputeCrackFrictionHeatEnergyDienesPrintQp::ComputeCrackFrictionHeatEnergyDienesPrintQp(const InputParameters & parameters)
...
void
ComputeCrackFrictionHeatEnergyDienesPrintQp::computeQpProperties()
{
  ...
  std::cout << "new quadrature point" << std::endl;
  std::cout << _qp << std::endl;
  std::cout << _q_point[_qp](0) << std::endl;
  std::cout << _q_point[_qp](1) << std::endl;
  std::cout << _q_point[_qp](2) << std::endl;
  std::cout << "heat source rate" << std::endl;
  std::cout << _heat_source_rate[_qp] << std::endl;
  std::cout << "damage phase field" << std::endl;
  std::cout << _c[_qp] << std::endl;
  std::cout << "dcdy" << std::endl;
  std::cout << _dcdy[_qp] << std::endl;
}

...
/****************************************************************/
#include "FiniteStrainCrystalPlasticityDamageSym.h"
...
InputParameters validParams<FiniteStrainCrystalPlasticityDamageSym>()
{
  ...
  params.addClassDescription("Crystal Plasticity base class. Damage. Symmetric model using"
                             "the principal values of the E (Lagrangian) strain tensor");
...
FiniteStrainCrystalPlasticityDamageSym::FiniteStrainCrystalPlasticityDamageSym(const InputParameters & parameters) :
    ...
    _W0e(declareProperty<Real>("W0e")), // total elastic energy
...
void
FiniteStrainCrystalPlasticityDamageSym::preSolveStatevar()
{
...
void
FiniteStrainCrystalPlasticityDamageSym::solveStatevar()
{
  Real gmax, gdiff;
  unsigned int iterg;
...
void
FiniteStrainCrystalPlasticityDamageSym::postSolveStatevar()
{
  if (_max_substep_iter == 1)//No substepping
  {
    _gss[_qp] = _gss_tmp;
 ...
 */
void
FiniteStrainCrystalPlasticityDamageSym::updateGss()
{
...
void
FiniteStrainCrystalPlasticityDamageSym::update_energies()
{
...
void
FiniteStrainCrystalPlasticityDamageSym::calcResidual( RankTwoTensor &resid )
{
  ...
  // Damage associated with total stress
  pk2_new = stress0pos * xfac;

  _pk2_undamaged[_qp] = stress0pos;
  ...
  // Energy with total strain (symmetric model)
  _W0e[_qp] = lambda * Utility::pow<2>(etr) / 2.0 + val;
...
void
FiniteStrainCrystalPlasticityDamageSym::getSlipIncrements()
{
  for (unsigned int i = 0; i < _nss; ++i)
  {

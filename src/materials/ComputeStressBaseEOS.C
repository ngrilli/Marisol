...
#include "ComputeStressBaseEOS.h"

template<>
InputParameters
validParams<ComputeStressBaseEOS>()
{
...
ComputeStressBaseEOS::ComputeStressBaseEOS(const InputParameters & parameters) :
...
void
ComputeStressBaseEOS::computeQpProperties()
{
...
void
ComputeStressBaseEOS::computeQpStress()
{
}

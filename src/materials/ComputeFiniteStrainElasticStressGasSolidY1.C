...
#include "ComputeFiniteStrainElasticStressGasSolidY1.h"

registerMooseObject("TensorMechanicsApp", ComputeFiniteStrainElasticStressGasSolidY1);

template <>
InputParameters
validParams<ComputeFiniteStrainElasticStressGasSolidY1>()
{
...
ComputeFiniteStrainElasticStressGasSolidY1::ComputeFiniteStrainElasticStressGasSolidY1(
...
void
ComputeFiniteStrainElasticStressGasSolidY1::initialSetup()
{
}

void
ComputeFiniteStrainElasticStressGasSolidY1::initQpStatefulProperties()
{
  ComputeStressBase::initQpStatefulProperties();
}

void
ComputeFiniteStrainElasticStressGasSolidY1::computeQpStress()
{
  ...
  iden.zero();
  iden.addIa(1.0);
  _stress[_qp] = (mass_fraction_1 * Peos_BM + mass_fraction_2_and_3 * Peos_MG) * iden;
...
void
ComputeFiniteStrainElasticStressGasSolidY1::rotateQpInitialStress()
{
}

...
/****************************************************************/
#include "FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken.h"
#include "petscblaslapack.h"
#include "libmesh/utility.h"

template<>
InputParameters validParams<FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken>()
{
...
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken(const InputParameters & parameters) :
...
void
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::preSolveStatevar()
{
...
void
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::solveStatevar()
{
  Real gmax, gdiff;
  unsigned int iterg;
...
void
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::postSolveStatevar()
{
  if (_max_substep_iter == 1)//No substepping
  {
    _gss[_qp] = _gss_tmp;
 ...
 */
void
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::updateGss()
{
...
void
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::update_energies()
{
...
void
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::calcResidual( RankTwoTensor &resid )
{
...
void
FiniteStrainCrystalPlasticityDamagePrincipalStrainsBroken::getSlipIncrements()
{
  for (unsigned int i = 0; i < _nss; ++i)
  {

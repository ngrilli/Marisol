...
/****************************************************************/
#include "FiniteStrainCrystalPlasticityPFFractureStress.h"
#include "petscblaslapack.h"
#include "libmesh/utility.h"
#include "MathUtils.h"

registerMooseObject("TensorMechanicsApp", FiniteStrainCrystalPlasticityPFFractureStress);
...
FiniteStrainCrystalPlasticityPFFractureStress::FiniteStrainCrystalPlasticityPFFractureStress(const InputParameters & parameters) :
...
void
FiniteStrainCrystalPlasticityPFFractureStress::initQpStatefulProperties()
{
  _stress[_qp].zero();
...
void
FiniteStrainCrystalPlasticityPFFractureStress::preSolveStatevar()
{
...
void
FiniteStrainCrystalPlasticityPFFractureStress::solveStatevar()
{
  Real gmax, gdiff;
  unsigned int iterg;
  ...
  {
#ifdef DEBUG
    mooseWarning("FiniteStrainCrystalPlasticityPFFractureStress: Hardness Integration error gmax", gmax, "\n");
#endif
    _err_tol = true;
  }
}
...
void
FiniteStrainCrystalPlasticityPFFractureStress::postSolveStatevar()
{
  if (_max_substep_iter == 1)//No substepping
  {
    _gss[_qp] = _gss_tmp;
 ...
 */
void
FiniteStrainCrystalPlasticityPFFractureStress::updateGss()
{
...
void
FiniteStrainCrystalPlasticityPFFractureStress::update_energies()
{
...
void
FiniteStrainCrystalPlasticityPFFractureStress::calcResidual( RankTwoTensor &resid )
{
...
void
FiniteStrainCrystalPlasticityPFFractureStress::getSlipIncrements()
{
  for (unsigned int i = 0; i < _nss; ++i)
  {

...
/****************************************************************/
#include "LinearIsoElasticPFPosVol.h"
#include "libmesh/utility.h"

template<>
InputParameters validParams<LinearIsoElasticPFPosVol>()
{
...
LinearIsoElasticPFPosVol::LinearIsoElasticPFPosVol(const InputParameters & parameters) :
...
void LinearIsoElasticPFPosVol::computeQpStress()
{
  updateVar();
  updateJacobian();
}
...
void
LinearIsoElasticPFPosVol::updateVar()
{
  ...
  stress0pos = 3 * Kb * vol_strain_pos;
  stress0neg = 3 * Kb * vol_strain_neg - mu * dev_strain;
...
void
LinearIsoElasticPFPosVol::updateJacobian()
{
